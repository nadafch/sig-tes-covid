...
if(!in_array($ext,$ekstensi) ) {
	...
	document.location.href = ' http://localhost/sig-teori-coba/pages/tambah_data.php';
	</script>
	";
}else{
	if($size < 1044070){      
		...
		document.location.href = ' http://localhost/sig-teori-coba/pages/daftar_tempat.php';
		</script>
		";
	}else{
		echo "<script> 
