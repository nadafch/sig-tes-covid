                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        while ($row1= mysqli_fetch_array($sql1)) {
                                            ...
                                            <td><img src='../image/".$row1['gambar']."' width='35' height='40'</td>
                                            <td width> <a href='http://localhost/sig-teori-coba/aksi/proses_delete.php?id_del=".$row1['id']."' class='btn btn-danger'>Delete</a></td>
                                            <td>
                                            <a href='http://localhost/sig-teori-coba/pages/ubah_data.php?id_edit=".$row1['id']."' class='btn btn-warning'>Edit</a></td>
                                            </td>";
                                        }
                                        ?>
                                    </table>
